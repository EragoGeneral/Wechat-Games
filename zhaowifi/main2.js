...
var imageData = [
    ...
    {name: "more_button", path: basePath + "more_button.png"},
...
function welcome() {
    ...
    addElements([
        ...
        {src: 'more_button',type:'button',center:true,Y:742,click_up:moreGame}
    ], bgLayer);
...
function moreGame(){
	window.location = 'http://wxsxz117.cc:8080/games/index.html';	
}
