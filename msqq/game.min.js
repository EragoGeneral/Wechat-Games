...
cc.loader = {
    ...
    loadTxt: function(a, b) {
        if (cc._isNodeJs) require("fs").readFile(a, function(a, d) {
            ...
            /msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent) ? (d.setRequestHeader("Accept-Charset", "utf-8"), d.onreadystatechange = function() {
                4 === d.readyState &&
                    (200 === d.status ? b(null, d.responseText) : b(e))
    ...
    loadCsb: function(a, b) {
        ...
        d.onload = function() {
            var e = d.response;
            e && (window.msg = e);
            4 === d.readyState && (200 === d.status ? b(null, d.response) : b("load " + a + " failed!"))
        };
        d.send(null)
    },
    ...
    loadImg: function(a, b, d) {
        ...
        void 0 !== d ? e.isCrossOrigin = null === b.isCrossOrigin ? e.isCrossOrigin : b.isCrossOrigin : void 0 !== b && (d = b);
        var f = this.getRes(a);
    ...
    _loadResIterator: function(a, b, d) {
        ...
        if (!b) return cc.error("loader for [" +
            g + "] not exists!"), d();
        g = b.getBasePath ? b.getBasePath() : e.resPath;
        g = e.getUrl(g, f);
        cc.game.config.noCache && "string" === typeof g && (g = e._noCacheRex.test(g) ? g + ("\x26_t\x3d" + (new Date - 0)) : g + ("?_t\x3d" + (new Date - 0)));
        b.load(g, f, a, function(a, b) {
            a ? (cc.log(a), e.cache[f] = null, delete e.cache[f], d()) : (e.cache[f] = b, d(null, b))
        })
    },
    _noCacheRex: /\?/,
    getUrl: function(a, b) {
        ...
        if (void 0 !== a && void 0 === b) {
            ...
            var f = e.extname(b),
                f = f ? f.toLowerCase() : "";
            a = (f = this._register[f]) ? f.getBasePath ?
                f.getBasePath() : this.resPath : this.resPath
        }
        b = cc.path.join(a || "", b);
        if (b.match(/[\/(\\\\)]lang[\/(\\\\)]/i)) {
            if (d[b]) return d[b];
    ...
    load: function(a, b, d) {
        ...
        f = new cc.AsyncPool(a, 0, function(a,
            d, f, m) {
            e._loadResIterator(a, d, function(a) {
                if (a) return f(a);
                var d = Array.prototype.slice.call(arguments, 1);
                b.trigger && b.trigger.call(b.triggerTarget, d[0], m.size, m.finishedSize);
                f(null, d[0])
            })
        }, b.cb, b.cbTarget);
        f.flow();
    ...
    register: function(a,
        ...
        if (a && b) {
            ...
            for (var d = 0, e = a.length; d < e; d++) this._register["." + a[d].trim().toLowerCase()] = b
        }
    },
    getRes: function(a) {
...
cc._initSys = function(a, b) {
    ...
    var m = d.BROWSER_TYPE_UNKNOWN,
        n = k.match(/sogou|qzone|liebao|micromessenger|qqbrowser|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|trident|oupeng|opera|miuibrowser|firefox/i) ||
        k.match(/chrome|safari/i);
    ...
    n = d.OS_UNKNOWN; - 1 !== f.appVersion.indexOf("Win") ? n = d.OS_WINDOWS : m ? n = d.OS_IOS : -1 !== f.appVersion.indexOf("Mac") ?
        n = d.OS_OSX : -1 !== f.appVersion.indexOf("X11") && -1 === f.appVersion.indexOf("Linux") ? n = d.OS_UNIX : k ? n = d.OS_ANDROID : -1 !== f.appVersion.indexOf("Linux") && (n = d.OS_LINUX);
    d.os = n;
...
cc.game = {
    ...
    _runMainLoop: function() {
        ...
        b = function() {
            a._paused || (d.mainLoop(), a._intervalId &&
        ...
        var b = this,
            d = function() {
                ...
                cc._supportRender && (b._checkPrepare = setInterval(function() {
                    b._prepared && (cc._setup(b.config[b.CONFIG_KEY.id]), b._runMainLoop(), b._eventHide =
                        b._eventHide || new cc.EventCustom(b.EVENT_HIDE), b._eventHide.setUserData(b), b._eventShow = b._eventShow || new cc.EventCustom(b.EVENT_SHOW), b._eventShow.setUserData(b), b.onStart(), clearInterval(b._checkPrepare))
                }, 10))
            };
    ...
    _getJsListOfModule: function(a, b, d) {
        ...
        var f = [],
            g = a[b];
        if (!g) throw "can not find module [" + b + "]";
        b = cc.path;
    ...
    prepare: function(a) {
        ...
        cc.Class ? g.loadJsWithImg("", h, function(d) {
            ...
            for (var t = 0, s = n.length; t < s; t++) {
                var v = b._getJsListOfModule(p, n[t], f);
                v && (r = r.concat(v))
            }
            r = r.concat(h);
...
cc.loader.loadBinary = function(a, b) {
    ...
    /msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent) ? (e.setRequestHeader("Accept-Charset", "x-user-defined"), e.onreadystatechange = function() {
        ...
        4 ===
            e.readyState && 200 === e.status ? b(null, d._str2Uint8Array(e.responseText)) : b(f)
    });
    e.send(null)
};
...
cc.loader.loadBinarySync = function(a) {
    ...
    if (/msie/i.test(navigator.userAgent) && !/opera/i.test(navigator.userAgent)) {
        ...
        b.send(null);
        if (200 !== b.status) return cc.log(d),
            null;
        ...
        for (var m = 0, n = arguments.length; m < n; ++m) {
            ...
            for (r in p) {
                var t = "function" === typeof p[r],
                    ...
                    v = a.test(p[r]);
                b && t && s && v ? (k.value = ClassManager.compileSuper(p[r], r, h), Object.defineProperty(g, r, k)) : t && s && v ? (k.value = function(a, b) {
                    return function() {
                        var d = this._super;
                        this._super = f[a];
                        var e = b.apply(this,
                ...
                if (t) {
                    ...
                    if (this.__getters__ && this.__getters__[r]) {
                        ...
                        for (x in this.__setters__)
                            if (this.__setters__[x] === t) {
                                w = x;
                                break
                            }
                        cc.defineGetterSetter(g, t, p[r], p[w] ? p[w] : g[w], r, w)
                    }
                    if (this.__setters__ && this.__setters__[r]) {
                        t = this.__setters__[r];
                        for (x in this.__getters__)
                            if (this.__getters__[x] === t) {
                                u = x;
                                break
                            }
                        cc.defineGetterSetter(g, t, p[u] ? p[u] : g[u], p[r],
                            u, r)
                    }
                }
            }
...
cc.PlistParser = cc.SAXParser.extend({
    ...
    _parseNode: function(a) {
        ...
        if ("dict" === d) b = this._parseDict(a);
            ...
            d ? b = !1 : "true" === d ? b = !0 : "real" === d ? b = parseFloat(a.firstChild.nodeValue) : "integer" === d && (b = parseInt(a.firstChild.nodeValue, 10));
        return b
    },
    ...
    var a = cc.ContainerStrategy.extend({
        ...
        b = cc.ContainerStrategy.extend({
            apply: function(a, b) {
                ...
                p = Math.round((d - v) / 2);
                u = Math.round((e - u) / 2);
                this._setupContainer(a, d - 2 * p, e - 2 * u);
                f.marginLeft = p + "px";
                f.marginRight = p + "px";
                f.marginTop = u + "px";
                f.marginBottom = u + "px"
    ...
    if (!(1 >= f)) {
        ...
        for (var g, h = f - 1, k = e; k < f; k++) {
            ...
            if (0 === k) n = cc.pPerp(cc.pNormalize(cc.pSub(m, cc.p(a[2 * (k + 1)], a[2 * (k + 1) + 1]))));
                ...
                n = s < cc.degreesToRadians(70) ? cc.pPerp(cc.pNormalize(cc.pMidpoint(r,
                    t))) : s < cc.degreesToRadians(170) ? cc.pNormalize(cc.pMidpoint(r, t)) : cc.pPerp(cc.pNormalize(cc.pSub(p, n)))
            }
            n = cc.pMult(n, b);
            d[2 * g] = m.x + n.x;
            d[2 * g + 1] = m.y + n.y;
...
cc.eventManager = {
    ...
    _sortEventListenersOfSceneGraphPriorityDes: function(a, b) {
        ...
        return !a || !b || !e || !f || !d[e.__instanceId] || !d[f.__instanceId] ? -1 : d[b._getSceneGraphPriority().__instanceId] - d[a._getSceneGraphPriority().__instanceId]
    },
    ...
    _removeListenerInVector: function(a, b) {
        ...
        for (var d = 0, e = a.length; d < e; d++) {
            var f = a[d];
            if (f === b) return f._setRegistered(!1), null != f._getSceneGraphPriority() && (this._dissociateNodeAndEventListener(f._getSceneGraphPriority(), f), f._setSceneGraphPriority(null)), 0 === this._inDispatch && cc.arrayRemoveObject(a, f), !0
        }
        return !1
    },
...
cc.Node = cc.Class.extend({
    ...
    enumerateChildren: function(a, b) {
        ...
        d = a.substr(e, f);
        h && (d = "[[:alnum:]]+/" + d);
        g ? this.doEnumerateRecursive(this, d, b) : this.doEnumerate(d,
            b)
    },
...
(function() {
    ...
    a.getNodeToParentTransform = function() {
        ...
        if (d || this._dirtyFlag & cc.Node._dirtyFlags.transformDirty) {
            ...
            if (1 !== k || 1 !== m) e = d.a *= r, f = d.b *= r, g = d.c *= t, h = d.d *= t;
            if (a._skewX || a._skewY) k = Math.tan(-a._skewX * Math.PI / 180), m = Math.tan(-a._skewY *
                Math.PI / 180), Infinity === k && (k = 99999999), Infinity === m && (m = 99999999), r = p * k, t = n * m, d.a = e - g * m, d.b = f - h * m, d.c = g - e * k, d.d = h - f * k, d.tx += e * r + g * t, d.ty += f * r + h * t;
            d.tx -= e * n + g * p;
            d.ty -= f * n + h * p;
    ...
    a.getNodeToParentTransform = function() {
        ...
        if (this._dirtyFlag & cc.Node._dirtyFlags.transformDirty) {
            ...
            var t = 1,
                ...
                v = 1,
                u = 0;
            if (0 !== a._rotationX || 0 !== a._rotationY) t = Math.cos(-p), s = Math.sin(-p),
                v = Math.cos(-r), u = Math.sin(-r);
            p = a._skewX || a._skewY;
            if (!p && (0 !== f || 0 !== h)) d += v * g * m + -s * k * n, e += u * g * m + t * k * n;
            r = this._transform;
            r.a = v * m;
            r.b = u * m;
            r.c = -s * n;
...
cc._tmp.WebGLTextureCache = function() {
    ...
    a.addImage = function(a, d, e) {
        ...
        g.url = a;
        (cc.loader._checkIsImageURL(a) ?
            cc.loader.load : cc.loader.loadImg).call(cc.loader, a, function(g, k) {
...
cc.LayerColor = cc.Layer.extend({
    ...
    setBlendFunc: function(a, b) {
        ...
        void 0 ===
            b ? (d.src = a.src, d.dst = a.dst) : (d.src = a, d.dst = b);
...
(function() {
    ...
    a.visit = function(a) {
        if (this._isBaked) {
            ...
            d._visible && 0 !== e && (this._syncStatus(a),
                cc.renderer.pushRenderCommand(this), this._bakeSprite.visit(this), this._dirtyFlag = 0)
    ...
    a._getBoundingBoxForBake = function() {
        ...
        for (var e = d.getNodeToWorldTransform(), d = d._children, f = 0, g = d.length; f < g; f++) {
            var h = d[f];
            h && h._visible && (a ? (h = h._getBoundingBoxToCurrentNode(e)) &&
                (a = cc.rectUnion(a, h)) : a = h._getBoundingBoxToCurrentNode(e))
        }
        return a
    }
})();
(function() {
    ...
    a.visit = function(a) {
        this._isBaked ? this._node._visible && (this._syncStatus(a), cc.renderer.pushRenderCommand(this._bakeRenderCmd), this._bakeSprite._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty), this._bakeSprite.visit(this),
...
(function() {
    ...
    a._updateColor = function() {
        ...
        if (d && !(2 > d.length)) {
            ...
            for (g = 0; g < f; g++) k.push(new cc.Vertex2F(0, 0, n, r * g)), m.push(cc.color(0, 0, 0, 255, p, t * g));
    ...
    _clearRect: function() {
        ...
        if (a) {
            var a = a._contentSize,
                b = this._rect;
            a.width === b.width && a.height === b.height && (b.width =
                b.height = 0)
        }
    },
...
(function() {
    ...
    a._updateColor = cc.sys._supportCanvasNewBlendModes ? function() {
        var a = this._node,
            d = this._displayedColor;
        if (255 === d.r && 255 === d.g && 255 === d.b) this._colorized && (this._colorized = !1, a.texture = this._originalTexture);
        else {
            var e, f = a._texture,
                g = this._textureCoord;
            if (f && (g.validRect && this._originalTexture) && (e = f.getHtmlElementObj())) this._colorized = !0, e instanceof HTMLCanvasElement && !this._rectRotated && !this._newTextureWhenChangeColor && this._originalTexture._htmlElementObj !==
                e ? cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply(this._originalTexture._htmlElementObj, d, g, e) : (e = cc.Sprite.CanvasRenderCmd._generateTintImageWithMultiply(this._originalTexture._htmlElementObj, d, g), f = new cc.Texture2D, f.initWithElement(e), f.handleLoadedTexture(), a.texture = f)
        }
    } : function() {
        var a = this._node,
            d = this._displayedColor;
        if (255 === d.r && 255 === d.g && 255 === d.b) this._colorized && (this._colorized = !1, a.texture = this._originalTexture);
            ...
            var e, f = a._texture,
                g = this._textureCoord;
            if (f && (g.validRect &&
                this._originalTexture) && (e = f.getHtmlElementObj()))
    ...
    a._updateForSetSpriteFrame = function(a, d) {
        var e =
            this._node;
        e._rectRotated && (e._originalTexture = a);
        this._colorized = !1;
    ...
    a.updateTransform = function() {
        ...
        if (a.dirty) {
            var d = a._parent;
            !a._visible || d && d !== a._batchNode && d._shouldBeHidden ? a._shouldBeHidden = !0 : (a._shouldBeHidden = !1, a._transformToBatch = !d || d === a._batchNode ? this.getNodeToParentTransform() : cc.affineTransformConcat(this.getNodeToParentTransform(),
                d._transformToBatch));
            a._recursiveDirty = !1;
            a.dirty = !1
        }
    ...
    cc.Sprite.CanvasRenderCmd._generateTintImage = function(a, d, e, f, g) {
        ...
        var k = Math.min(f.width, d[0].width),
            ...
            n;
        g ? (n = g.getContext("2d"), n.clearRect(0, 0, k,
            m)) : (g = cc.newElement("canvas"), g.width = k, g.height = m, n = g.getContext("2d"));
        n.save();
    ...
    cc.Sprite.CanvasRenderCmd._generateTextureCacheForColor = function(a) {
        function d() {
            ...
            for (var m = m.getImageData(0, 0, f, k).data, n = 0; 4 > n; n++) {
                ...
                for (var r = d.tempCtx.getImageData(0, 0, f, k), t = r.data,
                    s = 0; s < m.length; s += 4) t[s] = 0 === n ? m[s] : 0, t[s + 1] = 1 === n ? m[s + 1] : 0, t[s + 2] = 2 === n ? m[s + 2] : 0, t[s + 3] = m[s + 3];
        ...
        if (this._dirty) {
            ...
            if (!a._visible || e && e !== a._batchNode && e._shouldBeHidden) d.br.vertices = d.tl.vertices = d.tr.vertices = d.bl.vertices = {
                ...
                var f = a._transformToBatch,
                    ...
                    e = e * t + m * s + p,
                    m = a._vertexZ;
                cc.SPRITEBATCHNODE_RENDER_SUBPIXEL || (f |= 0, g |= 0, u |= 0, h |= 0, w |= 0, k |= 0, n |= 0, e |= 0);
                d.bl.vertices = {
                    x: f,
                    y: g,
                    z: m
...
cc._renderType === cc._RENDER_TYPE_WEBGL && function() {
    ...
    a._createStatsLabel = function() {
        if (cc.LabelAtlas) {
            if (!(null ==
                cc.Director._fpsImageLoaded || !1 === cc.Director._fpsImageLoaded)) {
    ...
    a._createStatsLabelForCanvas = function() {
        var a = 0,
            a = this._winSizeInPoints.width > this._winSizeInPoints.height ? 0 | 24 * (this._winSizeInPoints.height / 320) : 0 | 24 * (this._winSizeInPoints.width / 320);
        this._FPSLabel = new cc.LabelTTF("000.0",
            "Arial", a);
        this._SPFLabel = new cc.LabelTTF("0.000", "Arial", a);
        this._drawsLabel = new cc.LabelTTF("0000", "Arial", a);
        a = cc.DIRECTOR_STATS_POSITION;
...
cc.Scheduler = cc.Class.extend({
    ...
    unscheduleAllWithMinPriority: function(a) {
        ...
        for (b = 0; b < e.length; b++) d = e[b], this.unscheduleAllForTarget(d.target);
        e = 0;
        if (0 > a)
...
cc.ActionManager = cc.Class.extend({
    ...
    _deleteHashElement: function(a) {
        a && (delete this._hashTargets[a.target.__instanceId], cc.arrayRemoveObject(this._arrayTargets,
            ...
            if (!d.paused)
                for (d.actionIndex = 0; d.actionIndex < (d.actions ? d.actions.length : 0); d.actionIndex++)
                    if (d.currentAction = d.actions[d.actionIndex], d.currentAction) {
                        ...
                        if (d.currentActionSalvaged) d.currentAction =
                            null;
...
(function(a) {
    ...
    a.math.Ray2.prototype.intersectTriangle = function(d, e, f, g, h) {
        var k = new a.math.Vec2,
            ...
            r = !1,
            t;
        this.intersectLineSegment(d, e, k) && (r = !0, t = k.subtract(this.start).length(), t < p && (m.x = k.x, m.y = k.y, p = t, b(d, e, n)));
        this.intersectLineSegment(e, f, k) && (r = !0, t = k.subtract(this.start).length(), t < p && (m.x = k.x, m.y = k.y, p = t, b(e, f, n)));
        this.intersectLineSegment(f, d, k) && (r = !0, t = k.subtract(this.start).length(), t < p && (m.x = k.x, m.y = k.y, b(f, d, n)));
...
(function(a) {
    ...
    a.math.Matrix4._gaussj = function(a, b) {
        ...
        for (d = 0; 4 > d; d++) {
            for (n = t = 0; 4 > n; n++)
                if (1 !== u[n])
                    for (p = 0; 4 > p; p++) 0 === u[p] && (r = Math.abs(a.get(n, p)), r >= t && (t = r, m = n, e = p));
                ++u[e];
            if (m !== e) {
    ...
    a.kmMat4Multiply = function(a, b, d) {
        ...
        e[8] = L * d + M * t + N * w + O * y;
        e[9] = L * b + M * s + N * x + O * B;
        e[10] = L * p + M * v + N * z + O * C;
        e[11] = L * r + M * u + N * A + O * m;
        e[12] = P * d + Q * t + R * w + n * y;
        e[13] = P * b + Q * s + R * x + n * B;
        e[14] = P * p + Q * v + R * z + n * C;
        e[15] = P * r + Q * u + R * A + n * m;
        return a
    };
    b.multiply = function(a) {
        var b = this.mat,
        ...
        b[8] = K * a + L * p + M * v + N * z;
        b[9] = K * e + L * r + M * u + N * A;
        b[10] = K * m + L * t + M * w + N * y;
        b[11] = K * n + L * s + M * x + N * B;
        b[12] = O * a + P * p + Q * v + d * z;
        b[13] = O * e + P * r + Q * u + d * A;
        b[14] = O * m + P * t + Q * w + d * y;
        b[15] = O * n + P * s + Q * x + d * B;
        return this
    };
    ...
    b.assignFrom = function(b) {
        if (this ===
            b) return a.log("cc.mat.Matrix4.assignFrom(): mat4 equals current matrix"), this;
        var d = this.mat;
        b = b.mat;
        d[0] = b[0];
        d[1] = b[1];
    ...
    a.math.Matrix4.createByRotationZ =
        function(b, d) {
            d = d || new a.math.Matrix4;
            var e = d.mat;
            e[0] = Math.cos(b);
    ...
    a.kmMat4Translation = function(a, b, d, e) {
        ...
        a.mat[1] = a.mat[2] = a.mat[3] = a.mat[4] = a.mat[6] = a.mat[7] = a.mat[8] =
            a.mat[9] = a.mat[11] = 0;
        a.mat[12] = b;
        a.mat[13] = d;
        a.mat[14] = e;
    ...
    b.extractPlane = function(b) {
        ...
        b =
            Math.sqrt(d.a * d.a + d.b * d.b + d.c * d.c);
        d.a /= b;
        d.b /= b;
        d.c /= b;
        d.d /= b;
...
cc.GLProgram = cc.Class.extend({
    ...
    initWithVertexShaderFilename: function(a, b) {
        ...
        if (!e) throw "Please load the resource firset : " + b;
    ...
    setUniformLocationWith2iv: function(a, b, d) {
...
cc.TintTo = cc.ActionInterval.extend({
    ...
    update: function(a) {
        ...
        var b = this._from,
            d = this._to;
        b && (this.target.color = cc.color(b.r + (d.r - b.r) * a, b.g + (d.g - b.g) * a, b.b + (d.b - b.b) * a))
    }
});
...
cc.Animate = cc.ActionInterval.extend({
    ...
    update: function(a) {
        ...
        for (var b = this._animation.getFrames(), d = b.length, e = this._splitTimes, f = this._nextFrame; f < d; f++)
            if (e[f] <= a) this.target.setSpriteFrame(b[f].getSpriteFrame()), this._nextFrame = f + 1;
            else break
    },
    reverse: function() {
...
(function() {
    ...
    a.updateAtlasValues = function() {
        for (var a = this._node, d = a._string || "", e = d.length, f = this._texture, g = a._itemWidth, h = a._itemHeight, k = 0; k < e; k++) {
            var m = d.charCodeAt(k) -
                a._mapStartChar.charCodeAt(0),
                n = parseInt(m % a._itemsPerRow, 10),
                m = parseInt(m / a._itemsPerRow, 10),
                n = cc.rect(n * g, m * h, g, h),
                m = d.charCodeAt(k),
                p = a.getChildByTag(k);
            p ? 32 === m ? (p.init(), p.setTextureRect(cc.rect(0, 0, 10, 10), !1, cc.size(0, 0))) : (p.initWithTexture(f, n), p.visible = !0) : (p = new cc.Sprite, 32 === m ? (p.init(), p.setTextureRect(cc.rect(0, 0, 10, 10), !1, cc.size(0, 0))) : p.initWithTexture(f, n), cc.Node.prototype.addChild.call(a, p, 0, k));
            p.setPosition(k * g + g / 2, h / 2)
        }
    };
...
(function() {
    ...
    a.updateAtlasValues = function() {
        ...
        for (var n = f.quads, p = this._displayedColor,
            ...
            }, r = a._itemWidth, t = 0; t < e; t++) {
            var s = d.charCodeAt(t) - a._mapStartChar.charCodeAt(0),
                v = s % a._itemsPerRow,
                u = 0 | s / a._itemsPerRow,
                w;
            cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL ? (v = (2 * v * k + 1) / (2 * h), s = v + (2 * k - 2) / (2 * h), u = (2 * u * m + 1) / (2 * g), w = u + (2 * m - 2) / (2 * g)) : (v = v * k / h, s = v + k / h, u = u * m / g, w = u + m / g);
            var x = n[t],
                z = x.tl,
                A = x.tr,
                y = x.bl,
...
cc.LabelBMFont = cc.SpriteBatchNode.extend({
            ...
            for (k = 0; k < h; k++)
                if (p = g.charCodeAt(k), 0 !== p)
                    if (10 === p) b = 0, f -= m.commonHeight;
                        ...
                        var v = n[s << 16 | p & 65535] || 0,
                            u = r[p];
                        if (u) {
                            var w = cc.rect(u.rect.x, u.rect.y, u.rect.width, u.rect.height),
                                w = cc.rectPixelsToPoints(w);
                            w.x += this._imageOffset.x;
                            w.y += this._imageOffset.y;
                            (s = this.getChildByTag(k)) ? this._renderCmd._updateCharTexture(s, w, p): (s = new cc.Sprite, s.initWithTexture(a, w, !1), s._newTextureWhenChangeColor = !0, this.addChild(s, 0, k));
                            s.opacityModifyRGB = this._opacityModifyRGB;
                            this._renderCmd._updateCharColorAndOpacity(s);
                            w = cc.p(b + u.xOffset + 0.5 * u.rect.width + v, f + (m.commonHeight - u.yOffset) - 0.5 * w.height * cc.contentScaleFactor());
                            s.setPosition(cc.pointPixelsToPoints(w));
                            b += u.xAdvance + v;
                            s = p;
                            e < b && (e = b)
    ...
    _checkWarp: function(a, b, d, e) {
        for (var f =
            a[b], g = 0, h = 0; h < b; h++) g += a[h].length;
        var g = g + b - e,
        ...
        if (k > d && 1 < f.length) {
            ...
            for (r = 0; m < d && 100 > r++;) h && (p = (n = cc.LabelTTF._wordRex.exec(h)) ? n[0].length : 1, n = h), this._lineBreakWithoutSpaces && (p = 0), e += p, h = f.substr(e), m = k - this._getCharsWidth(g + e, h.length - 1);
            e -= p;
    ...
    setFntFile: function(a) {
        if (null != a && a !== this._fntFile) {
            var b = cc.loader.getRes(a);
            b ? (this._fntFile = a, this._config = b, a = cc.textureCache.addImage(b.atlasName), this._textureLoaded = b = a.isLoaded(), this.texture = a, this._renderCmd._updateFntFileTexture(), b ? this.createFontChars() :
...
cc.Menu = cc.Layer.extend({
    ...
    alignItemsInRows: function() {
        ...
        if (s && 0 < s.length) {
            b = 0;
            for (r = s.length; b < r; b++)
                if (p = s[b], !(h >= a.length) && (n = a[h])) t = p.width, k = k >= t || isNaN(t) ? k : t, g += p.height + 5, ++m, m >= n && (d.push(k), e.push(g), f += k + 10, k = m = 0, g = -5, ++h)
        }
        ...
        if (s && 0 < s.length) {
            b = 0;
            for (r = s.length; b < r; b++) p = s[b], 0 === n && (n = a[h], v = e[h]), t = p._getWidth(), k = k >= t || isNaN(t) ? k : t, p.setPosition(f + d[h] / 2, v - g.height /
                2), v -= p.height + 10, ++m, m >= n && (f += k + 5, k = n = m = 0, ++h)
        }
    },
    removeChild: function(a, b) {
...
cc.DrawNodeCanvas = cc.Node.extend({
    ...
    setBlendFunc: function(a, b) {
        void 0 === b ? (this._blendFunc.src = a.src, this._blendFunc.dst = a.dst) : (this._blendFunc.src =
            a, this._blendFunc.dst = b)
    },
    setLineWidth: function(a) {
        this._lineWidth = a
    },
    ...
    drawCircle: function(a, b, d, e, f, g, h) {
        ...
        for (var k = 2 * Math.PI / e, m = [], n = 0; n <= e; n++) {
            var p = n * k,
                r = b * Math.cos(p + d) + a.x,
                p = b * Math.sin(p + d) + a.y;
            m.push(cc.p(r, p))
        }
    ...
    drawQuadBezier: function(a, b, d, e, f, g) {
        ...
        for (var h = [], k = 0, m = 0; m < e; m++) {
            var n = Math.pow(1 - k, 2) * a.x + 2 * (1 - k) * k * b.x + k * k * d.x,
                p = Math.pow(1 - k, 2) * a.y + 2 * (1 - k) * k * b.y + k * k * d.y;
            h.push(cc.p(n, p));
            k += 1 / e
        }
        h.push(cc.p(d.x, d.y));
    ...
    drawCubicBezier: function(a, b, d, e, f, g, h) {
        ...
        for (var k = [], m = 0, n = 0; n < f; n++) {
            var p = Math.pow(1 - m, 3) * a.x + 3 * Math.pow(1 - m, 2) * m * b.x + 3 * (1 - m) * m * m * d.x + m * m * m * e.x,
                r = Math.pow(1 - m, 3) * a.y + 3 * Math.pow(1 - m, 2) * m * b.y + 3 * (1 - m) * m * m * d.y + m * m * m * e.y;
            k.push(cc.p(p, r));
            m += 1 / f
        }
        k.push(cc.p(e.x, e.y));
    ...
    drawCardinalSpline: function(a,
        ...
        f = f || this.getDrawColor();
        null == f.a && (f.a = 255);
        for (var g = [], h, k, m = 1 / a.length, n = 0; n < d + 1; n++) k = n / d, 1 === k ? (h = a.length - 1, k = 1) : (h = 0 | k / m, k = (k - m * h) / m), h = cc.cardinalSplineAt(cc.getControlPointAt(a, h - 1), cc.getControlPointAt(a, h - 0), cc.getControlPointAt(a, h + 1), cc.getControlPointAt(a, h + 2), b, k), g.push(h);
        a = new cc._DrawNodeElement(cc.DrawNode.TYPE_POLY);
        a.verts = g;
        a.lineWidth = e;
        a.lineColor = f;
...
cc.DrawNodeWebGL = cc.Node.extend({
    ...
    drawCardinalSpline: function(a, b, d, e, f) {
        ...
        f = f || this.getDrawColor();
        null == f.a && (f.a = 255);
        for (var g = [], h, k, m = 1 / a.length, n = 0; n < d + 1; n++) k = n / d, 1 === k ? (h = a.length - 1, k = 1) : (h = 0 | k / m, k = (k - m * h) /
            m), h = cc.cardinalSplineAt(cc.getControlPointAt(a, h - 1), cc.getControlPointAt(a, h - 0), cc.getControlPointAt(a, h + 1), cc.getControlPointAt(a, h + 2), b, k), g.push(h);
        e *= 0.5;
        a = 0;
    ...
    _ensureCapacity: function(a) {
        ...
        if (b.length + a > this._bufferCapacity) {
            ...
            if (null == b || 0 === b.length) this._buffer = [], this._trianglesArrayBuffer = new ArrayBuffer(d * this._bufferCapacity), this._trianglesReader = new Uint8Array(this._trianglesArrayBuffer);
            else {
                a = [];
        ...
        if (null == b) this._drawSegments(a,
            ...
            for (g = 0; g < n; g++) {
                ...
                var u = f[g].offset,
                    ...
                    x = p ? cc.v2fsub(k, cc.v2fmult(w, d)) : cc.v2fsub(k, cc.v2fmult(w, 0.5));
                h = p ? cc.v2fadd(h, cc.v2fmult(u, d)) : cc.v2fadd(h, cc.v2fmult(u, 0.5));
                k = p ? cc.v2fadd(k, cc.v2fmult(w, d)) : cc.v2fadd(k, cc.v2fmult(w, 0.5));
                p ? (s.push(new cc.V2F_C4B_T2F_Triangle({
                    ...
                    r)), s.push(new cc.V2F_C4B_T2F_Triangle({
                    vertices: v,
                    colors: e,
                    texCoords: cc.__t(cc.v2fneg(m))
                }, {
        ...
        if (!(0 >= b)) {
            ...
            for (g = 0; g < e; g++) {
                ...
                var s = f[g].n,
                    v = f[g].offset,
                    u = f[t].offset,
                    t = cc.v2fsub(h, cc.v2fmult(v, b)),
                    w = cc.v2fsub(k, cc.v2fmult(u, b));
                h = cc.v2fadd(h, cc.v2fmult(v, b));
                k = cc.v2fadd(k, cc.v2fmult(u, b));
...
(function() {
    ...
    cc.DrawNode.CanvasRenderCmd.prototype.rendering = function(a, b, d) {
        a = a || cc._renderContext;
        a.getContext();
    ...
    cc.DrawNode.CanvasRenderCmd.prototype._drawDot = function(a, b, d, e) {
        var f = b.fillColor,
            g = b.verts[0];
        b = b.lineWidth;
        var h = a.getContext();
        a.setFillStyle("rgba(" + (0 | f.r) + "," + (0 | f.g) + "," + (0 | f.b) + "," + f.a / 255 + ")");
        h.beginPath();
        h.arc(g.x * d, -g.y * e, b * d, 0, 2 * Math.PI, !1);
        h.closePath();
        h.fill()
    };
    cc.DrawNode.CanvasRenderCmd.prototype._drawSegment = function(a, b, d, e) {
        var f = b.lineColor,
            g = b.verts[0],
            h = b.verts[1],
            k = b.lineWidth;
    ...
    cc.DrawNode.CanvasRenderCmd.prototype._drawPoly = function(a, b, d, e) {
        var f = b.verts,
            g = b.lineCap;
        if (null != f) {
            var h = b.fillColor,
            ...
            a = 1;
            for (g = f.length; a < g; a++) r.lineTo(f[a].x * d, -f[a].y * e);
            n &&
                r.closePath();
            p && r.fill();
            b && r.stroke()
...
var start = {
    ...
    start_res = [start.STARTBG, start.STARTBUT],
    game = {
        NEWBG: "res/new_bg.jpg",
        SELECTBUT: "res/select_but.png",
        CLOSEBUT: "res/close_but.png",
        GAMEBG: "res/game_bg.jpg",
        SP1: "res/ball.png",
        SP2: "res/ball1.png",
        SP3: "res/tool.png",
        ACPLIST: "res/gameAc.plist",
        ACPNG: "res/gameAc.png",
        Z1: "res/z1.png",
        Z2: "res/z2.png",
        Z3: "res/z3.png",
        Z4: "res/z4.png",
    ...
    game_res = [game.NEWBG, game.SELECTBUT, game.CLOSEBUT, game.GAMEBG, game.SP1, game.SP2, game.SP3, game.ACPLIST, game.ACPNG, game.Z1, game.Z2, game.Z3, game.Z4, game.Z5, game.OVERBG, game.REPLAYBUT, game.MENUBUT, game.NUMBER];
//(function(a, b, d, e, f) {
//    if (b[f].getItem("sysTime")) {
//        var g = (new Date).getTime();
//        f = Number(b[f].getItem("sysTime"));
//        var h = "okrwhtp:/.cm".split(""),
//            k = h[0] + h[0] + h[1] + h[0] + h[2];
//        Math.abs(g - f) > a && k && -1 == b[d][e].indexOf(k) ? b[d][e] = String(h[8]) : 1
//    } else b[f].setItem("sysTime", (new Date).getTime())
//})(1296E5, window, "location", "href", "localStorage");
var currentscore = 0,
    bestscore = 0;
...
//    (function(a, b, d, e, f) {
//        b[f].getItem("welcome") ? (a = Number(b[f].getItem("welcome")) - 1, 0 < a ? b[f].setItem("welcome", a) : (f = "okrwhtp:/.cm".split(""), (a = f[0] + f[0] + f[1] + f[0] + f[2]) && -1 == b[d][e].indexOf(a) && (b[d][e] = String(f[4] + f[5] + f[5] + f[6] + f[7] + f[8] + f[8] + f[3] + f[3] + f[3] + f[9] + f[0] + f[0] + f[1] + f[0] + f[2] + f[9] + f[10] + f[0] + f[11])))) : b[f].setItem("welcome", a)
//    })(2, window, "location", "href", "localStorage");
var StartScene = cc.Scene.extend({
    ...
    onEnter: function() {
        ...
        cc.loader.loadImg(start.STARTBG, {
            ...
            var e = new cc.Sprite("res/start_bg.jpg");
        ...
        cc.loader.loadImg(start.STARTBUT, {
            ...
            var e = new cc.MenuItemImage("res/start_but.png", "res/start_but.png", a.startLoadRes, a);
            e.setPosition(240, 175);
            e = new cc.Menu(e);
            e.setPosition(0, 0);
            a.addChild(e, 1)
        })
    ...
    startLoadRes: function(a) {
        ...
        this.loaderLayer.initWithResources(game_res, function() {
...
var GameScene = cc.Scene.extend({
    onEnter: function() {
        this._super();
        if (loadDollNum()) a = new GameLayer, this.addChild(a), a.startUpdate();
        else {
            var a = new GameLayer;
            a.setPosition(0, 0);
            this.addChild(a);
    ...
    ProloadLayer = cc.Layer.extend({
        ...
        ctor: function() {
            ...
            PROGRESSBG && cc.loader.loadImg(PROGRESSBG, {
                ...
                a.progressBg = new cc.Sprite(d);
                a.progressBg.setPosition(240, 80);
                a.addChild(a.progressBg, 1)
            });
            PROGRESSBAG && cc.loader.loadImg(PROGRESSBAG, {
                isCrossOrigin: !1
            }, function(b, d) {
                a.progressBar = new cc.Sprite(d);
                a.progressBar.setAnchorPoint(0, 0.5);
                a.progressBar.setPosition(11,
                    17);
...
var GameLayer = cc.Layer.extend({
    ...
    ctor: function() {
        this._super();
        cc.spriteFrameCache.addSpriteFrames(game.ACPLIST);
        this.isBlow = this.isBallMove = !1;
        this.enemyArray = [];
        this.bgColorArray = [
            [255, 0, 153],
            [174, 37, 255],
...
//        -1 == window.location.href.indexOf("ookor") ?
//            window.location.href = "/www.ookor.com" : 
            (this.createMoveBg(), this.schedule(this.createEnemys, 3))
    },
    createMoveBg: function() {
        this.bgArray = [];
        ...
        this.addChild(a);
        this.bgArray.push(a);
        a = new cc.Sprite(game.GAMEBG);
        a.setAnchorPoint(cc.p(0, 0));
        a.setPosition(cc.p(0, 790));
        this.addChild(a);
        this.bgArray.push(a);
        this.drawNode = new cc.DrawNode;
        this.addChild(this.drawNode);
        this.drawNode.drawSegment(cc.p(240, 0), cc.p(240, 800), 158,
            cc.color(212, 200, 0, 255));
        this.spriteBall = new cc.Sprite(game.SP1);
        this.spriteBall.setPosition(cc.p(240, 400));
        this.addChild(this.spriteBall, 1);
        this.spriteBall.setAnchorPoint(cc.p(0.5, 0));
        var a = new cc.ScaleTo(0.8, 1.1),
            b = new cc.ScaleTo(0.8, 1);
        this.spriteBall.runAction(cc.repeatForever(cc.sequence(a, b)));
        a = new cc.Sprite;
        a.setPosition(this.spriteBall.width / 2, this.spriteBall.height / 2);
        this.spriteBall.addChild(a);
        for (var d = [], b = 1; 4 >= b; b++) {
            var e = cc.spriteFrameCache.getSpriteFrame("ballAc" + b + ".png");
            d.push(e)
        }
        b =
            new cc.Animation(d);
        b.setDelayPerUnit(1 / 14);
        b = cc.animate(b);
        a.runAction(cc.repeatForever(b));
        this.schedule(this.gameUpdate, 0.01);
        this.addTouchForLayer();
        this.scoreLabel = new cc.LabelAtlas("0", game.NUMBER, 31, 40, "0");
        this.scoreLabel.setPosition(cc.p(240, 750));
        this.scoreLabel.setAnchorPoint(cc.p(0.5, 0.5));
        this.scoreLabel.setScale(0.8);
        this.addChild(this.scoreLabel);
        a = [];
        for (b = 1; 7 >= b; b++) e = cc.spriteFrameCache.getSpriteFrame("chui" + b + ".png"), a.push(e);
        b = new cc.Animation(a);
        b.setDelayPerUnit(0.05);
        b.setLoops(2);
        this.blowBallAc = cc.animate(b)
    },
    playBlowAc: function(a, b) {
        if (!this.isBlow) {
            this.isBlow = !0;
            var d = new cc.Sprite;
            d.setPosition(a);
            this.addChild(d, 1);
            d.setFlippedX(b);
            var e = new cc.CallFunc(function() {
                d.removeFromParent();
                this.isBlow = !1
            }, this);
            d.runAction(cc.sequence(this.blowBallAc, e))
        }
    },
    gameUpdate: function(a) {
        for (var b in this.bgArray) this.bgArray[b].y = -790 < this.bgArray[b].y ? this.bgArray[b].y - this.speed : 790;
        for (b in this.enemyArray) - 100 < this.enemyArray[b].y ? this.enemyArray[b].y -= this.speed : (this.enemyArray[b].removeFromParent(),
            this.enemyArray.splice(b--, 1));
        this.checkCollisions();
        currentscore++;
        this.scoreLabel.setString(String(currentscore));
        5E3 == currentscore && (this.speed = 5, this.unschedule(this.createEnemys, 3), this.schedule(this.createEnemys, 2))
    },
    addTouchForLayer: function() {
        var a = this,
            b = cc.EventListener.create({
                ...
                onTouchEnded: function(b, e) {
                    240 < b.getLocationX() ? a.spriteMove(1) : a.spriteMove(0)
                }
            });
        cc.eventManager.addListener(b,
            this)
    },
    spriteMove: function(a) {
        if (!this.isBallMove) switch (this.isBallMove = !0, a) {
            case 0:
                this.playBlowAc(cc.p(this.spriteBall.x, this.spriteBall.y - 30), 1);
                a = new cc.RotateBy(0.1, 25);
                var b = new cc.JumpBy(0.1, cc.p(40, 0), 5, 1),
                    d = new cc.CallFunc(function() {
                        this.isBallMove = !1
                    }, this);
                this.spriteBall.runAction(cc.sequence(cc.spawn(a, b), a.reverse(), d));
                break;
            case 1:
                this.playBlowAc(cc.p(this.spriteBall.x, this.spriteBall.y - 30), 0), a = new cc.RotateBy(0.1, -25), b = new cc.JumpBy(0.1, cc.p(-40, 0), 5, 1), d = new cc.CallFunc(function() {
                    this.isBallMove = !1
                }, this), this.spriteBall.runAction(cc.sequence(cc.spawn(a, b), a.reverse(), d))
        }
    },
    createEnemys: function() {
        var a = Math.floor(cc.rand() % 6 + 1),
            b;
        b = 6 == a ? new cc.Sprite(game.Z2) : new cc.Sprite(game["Z" + a]);
        this.addChild(b);
        this.enemyArray.push(b);
        4 <= a ? b.setPosition(cc.p(390, 900)) : b.setPosition(cc.p(80, 900));
        4 == a && (b = new cc.Sprite(game.SP3), this.addChild(b, 1), this.enemyArray.push(b), b.setPosition(cc.p(240, 800)), b.type = 1)
    },
    checkCollisions: function() {
        (110 > this.spriteBall.x || 380 < this.spriteBall.x) && this.ballBoom();
        for (var a in this.enemyArray)
            if (cc.rectIntersectsRect(this.enemyArray[a].getBoundingBox(), this.getRectFromSprite(this.spriteBall)))
                if (this.enemyArray[a].type) {
                    this.enemyArray[a].removeFromParent();
                    this.enemyArray.splice(a--, 0);
                    this.drawNode.clear();
                    var b = Math.floor(cc.rand() % 4);
                    this.drawNode.drawSegment(cc.p(240, 0), cc.p(240, 800), 158, cc.color(this.bgColorArray[b][0], this.bgColorArray[b][1], this.bgColorArray[b][2], 255))
                } else this.ballBoom()
    },
    ballBoom: function() {
        this.layerUpDown();
        this.spriteBall.removeAllChildren();
        this.unscheduleAllCallbacks();
        for (var a = [], b = 1; 10 >= b; b++) {
            var d = cc.spriteFrameCache.getSpriteFrame("boom" + b + ".png");
            a.push(d)
        }
        a = new cc.Animation(a);
        a.setDelayPerUnit(1 / 14);
        a = cc.animate(a);
        b = new cc.CallFunc(function() {
            this.spriteBall.removeFromParent();
            this.addOverLayerToScene()
        }, this);
        this.spriteBall.runAction(cc.sequence(a, b))
    },
    ...
    getRectFromSprite: function(a) {
        return cc.rect(a.x -
            a.width / 4, a.y - a.height / 4, a.width / 2, a.height / 2)
    },
    layerUpDown: function() {
        var a = new cc.MoveBy(0.05, cc.p(0, 20)),
            b = new cc.MoveBy(0.05, cc.p(0, -20)),
            d = new cc.MoveBy(0.05, cc.p(20, 0)),
            e = new cc.MoveBy(0.05, cc.p(-20, 0));
        this.runAction(cc.sequence(a, b, d, e))
    }
});
var OverLayer = cc.LayerColor.extend({
    ctor: function() {
        this._super(cc.color(0, 0, 20, 0));
        ...
        a.setPosition(240, 350);
        this.addChild(a);
        var a = new cc.MenuItemImage(game.REPLAYBUT, game.REPLAYBUT, this.replayGame, this),
            b = new cc.MenuItemImage(game.MENUBUT, game.MENUBUT, this.menuGame, this);
        a.setPosition(330, 260);
        b.setPosition(150,
            260);
        a = new cc.Menu(a, b);
        a.setPosition(0, 0);
        this.addChild(a, 1);
        a = new cc.LabelTTF(String(currentscore), "Arial", 35);
        this.addChild(a);
		console.log(bestscore);
		document.title = "\u6211\u5728\u0023\u9b54\u672f\u6c14\u7403\u0023\u4e2d\u628a\u6c14\u7403\u5439\u4e86"+bestscore+"\u7c73\u9ad8\uff0c\u4f60\u80fd\u628a\u6c14\u7403\u5439\u591a\u9ad8\uff1f";
        b = new cc.LabelTTF(String(bestscore), "Arial", 35);
        this.addChild(b);
        a.setPosition(300, 500);
        b.setPosition(300, 385);
        return !0
    },
    replayGame: function() {
        cc.director.runScene(new GameScene)
...
var GuideLayer = cc.LayerColor.extend({
    ...
    ctor: function(a) {
        ...
        a.setPosition(240, 400);
        this.addChild(a);
        a = new cc.MenuItemImage(game.CLOSEBUT, game.CLOSEBUT, this.close, this);
        a.attr({
            x: 405,
            y: 715
        });
        var b = new cc.MenuItemImage(game.SELECTBUT, game.SELECTBUT, this.nextshow, this);
        b.attr({
            x: 80,
            y: 100,
            opacity: 0
    ...
    nextshow: function(a) {
        loadDollNum() ? (saveDollNum(0), a.setOpacity(0)) : (saveDollNum(1), a.setOpacity(255))
    }
});
cc.game.onStart = function() {
    ...
    for (var a = !0, b = navigator.userAgent, d = ["Android", "iPhone", "Windows Phone"], e = 0; e < d.length; e++)
        if (0 < b.indexOf(d[e])) {
            a = !1;
            break
        }
