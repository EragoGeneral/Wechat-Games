...
~function(bt) {
    bt.URL = {
        root: "http://www.sina.com",
        getMoreGame: function() {
            bt.dc("more");
            return "http://www.wxsxz117.cc:8080/games/index.html"
        },
        getConcern: function() {
            return "http://mp.weixin.qq.com/mp/getmasssendmsg?__biz=MzIwODY5MzI3MA==#wechat_webview_type=1&wechat_redirect"
        },
        appId: ""
    };
