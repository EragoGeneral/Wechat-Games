...
"undefined" == typeof window.define && (window.define = function() {}, window.define.amd = 1),
    ...
    $AJB.general.Game = function() {
                ...
                h.on("passed", function() {
                    i.switchStage(0, function() {
                        h.enabled = !1,
							...
							document.title = window.shareData.tContent = window.shareData.tTitle = "我玩到了第"+D+"关，全世界只有6个人玩到了第17关！"
        ...
        var h, i, j, k = $AJB.general.Scene(),
            ...
            y = 60,
            z = "core-ball-level",
            A = "我玩到第#{level}关，求超越求蹂躏！",
            B = "sinaweibo://share?content=我玩到第#{level}关，求超越求蹂躏！",
            C = m(s),
            D = +o.getValue(z) || 1,
            E = !1,
            F = 0,
    ...
    $AJB.page.index = function() {
		...
		//document.title = window.shareData.tContent = window.shareData.tTitle = "我玩到了第"+window.localStorage["core-ball-level"]+"关，全世界只有6个人玩到了第17关!"
